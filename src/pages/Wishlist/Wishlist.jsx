...
export default function Wishlist() {
  const { wishlistInfo, getWishlistProducts, removeProductFromWishlist } =
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="View and manage your wishlist. Add products to cart or remove them from your favorites."
        />
      </Helmet>
      {!wishlistInfo ? (
        <Loading />
        ...
        <section className="p-3">
          ...
          {wishlistInfo.data.length === 0 ? (
            ...
            wishlistInfo.data.map((product) => {
              return (
                <div
                  className="bg-slate-50 relative py-6 px-4 mb-5 rounded-lg flex items-center"
                  key={product.id}
                >
