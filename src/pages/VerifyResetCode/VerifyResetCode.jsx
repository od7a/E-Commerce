  ...
  const formik = useFormik({
    ...
    onSubmit: async function (values) {
      const loadingClose = toast.loading(
        "Verifying reset code... Please wait."
      );
      try {
        const options = {
        ...
        if (data.status === "Success") {
          toast.success(
            "Reset code verified! Redirecting to reset password page...",
            {
              position: "top-center",
            }
          );
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Enter the reset code sent to your email to verify your account."
        />
      </Helmet>
